...
// 显式实例化常用类型
template RetCode Add<float>(Device*, const float*, const float*, float*, const TensorShape&);
template RetCode Add<float16_t>(Device*, const float16_t*, const float16_t*, float16_t*, const TensorShape&);
template RetCode Add<int32_t>(Device*, const int32_t*, const int32_t*, int32_t*, const TensorShape&);
template RetCode Add<int64_t>(Device*, const int64_t*, const int64_t*, int64_t*, const TensorShape&);
